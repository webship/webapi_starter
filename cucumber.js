module.exports = {
  default: {
    ...
    worldParameters: {
      ...
      // Test users for the roles of the WebAPI Starter site template.
      //
      // Webmaster is the site-install super-admin (created by `drush
      // site:install ... --account-name=webmaster
      // --account-pass=dD.123123ddd`). The rest are provisioned by
      // `Given I add testing users` (see
      // tests/step-definitions/webapi_starter.steps.js). That step iterates
      // this registry and skips entries flagged `isAdmin: true`.
      users: {
        Webmaster: {
          username: 'webmaster',
      ...
      selectors: {
        ...
        files: ['cms-drupal-core-claro.json'],
        offset: 60,
        breakpoints: {
